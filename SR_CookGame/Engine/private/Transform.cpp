...
void CTransform::Stand_OnTerrain(CVIBuffer_Terrain * pVIBuffer, const _matrix* pTerrainWorldMatrix)
{
	/* 지형버퍼의 로컬로 이동하자. */
	...
	/* 평면과 점과의 거리. */
	vLocalPos.y = vLocalPos.y - D3DXPlaneDotCoord(&Plane, &vLocalPos) + 0.5F;
