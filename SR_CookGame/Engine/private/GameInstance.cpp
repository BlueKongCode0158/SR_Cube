...
_uint CGameInstance::Get_GameObjectMapSize(_uint iLevelIndex, const _tchar * pLayerTag)
{
	if (nullptr == m_pObject_Manager)
		return 0;
	return m_pObject_Manager->Get_GameObjectMapSize(iLevelIndex, pLayerTag);
}
